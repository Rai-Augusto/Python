...
vol = l1 * l2 * l3
print (
    'O volume do cubo de altura {}, de base {} e profundidade {} é {} metros cúbicos e {} litros'.format ( l1, l2, l3,
                                                                                                           vol,
                                                                                                           vol * 1000 ) )
# Ex.012
prod = float ( input ( 'Qual o preço do produto desejado? R$ ' ) )
print ( 'O produto desejado R$ {:.2f}, está em promoção e com desconto de 20% custando RS{:.2f} '.format ( prod,
                                                                                                           prod * (
                                                                                                                       80 / 100) ) )
# Ex.013
...
print ( 'A temperatura {:.1f} em Fahrenheit vale {:.1f}°F e em Kelvin {:.2f}°K'.format ( t, (t * 9 / 5) + 32, t + 273,
                                                                                         16 ) )
# Ex.015
