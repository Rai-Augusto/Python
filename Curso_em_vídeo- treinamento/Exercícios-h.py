...
if prestaçao >= min :
    ...
    print ('O crédito será liberado, as prestações a serem pagas serão de {:.2f} e deverão ser pagas dentro dos {} anos, caso contrario a devidas medidas serão tomadas.'.format( prestaçao , anos ))
#Ex.037
