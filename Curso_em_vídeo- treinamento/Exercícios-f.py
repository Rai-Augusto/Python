...
if velocidade > 80 :
    print ('Você está acima do limite de velocidade permitido! Você será multado imediatamente no valor de R${} ! Espero que a punição seja educativa para você! Dirija com prudência!'.format((velocidade-80) * 7))
else:
